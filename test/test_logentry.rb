...
describe 'LogEntry parse' do
  ...
  it 'should parse + entry' do
    @subject = Todo::LogEntry.parse("+ [Tue Sep 20 12:13:00 EDT 2011] some categories, a task")
  ...
  it 'should parse - entry' do
    @subject = Todo::LogEntry.parse("- [Tue Sep 20 12:13:00 EDT 2011] some more categories, a task")
    assert subject_parsed
    assert @subject.sub?
  ...
  it 'should parse * entry' do
    @subject = Todo::LogEntry.parse("* [Tue Sep 20 12:13:00 EDT 2011] cat, a task")
    assert subject_parsed
  ...
  it 'should not parse entry with no categories' do
    @subject = Todo::LogEntry.parse("+ [Tue Sep 20 12:13:00 EDT 2011] a task")
    assert_nil @subject
  end
